...
#include <memory>
#include "../fury-dps-sim/clickablelabel.h"
...
QT_MOC_LITERAL(3, 28, 12) // "rightClicked"
    ...
    "ClickableLabel\0leftClicked\0\0rightClicked"
};
...
void ClickableLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickableLabel::leftClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ClickableLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickableLabel::rightClicked)) {
                *result = 1;
                return;
            }
        }
